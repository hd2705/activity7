                                 ...
                                 margin = 50)
{
    ...
    legends_items.append("rect")
        ...
        .on("click", function (event, category) {
            // Toggle opacity of bubbles based on the category
            const bubbles = d3.selectAll(`.${category}`);
            const currentOpacity = bubbles.style("opacity");
            bubbles.style("opacity", currentOpacity === "1" ? "0.2" : "1");
        });
